  ...
  try
    ...
    begin
      case E.Errors[0].ErrorCode of
        $2606: MSGERRO('Exclusão não Permitida!'); // Problemas com integridade
      end;
    end;
  end;
end;
...
begin
  try
    ...
    on E: EDBEngineError do
    begin
      case E.Errors[0].ErrorCode of // Exceções do banco
        $3303: MSGERRO('Gravação não Permitida!');
        9733: MSGERRO('Erro na Gravação de Dados!');
      end;
...
begin
  if (not DmDta.quPerSoftwarepsw_nivel.IsNull) and
    ...
    case DmDta.quPerSoftwarepsw_nivel.AsInteger of
      ...
      2: DmDta.quPerSoftwareNivel.Text := 'Ótimo';
    end;
end;
...
begin
  try
    case quVagaSoftware.FieldByName('vsw_nivel').AsInteger of
      0: quVagaSoftware.FieldByName('Nivel').Value := 'Básico';
      1: quVagaSoftware.FieldByName('Nivel').Value := 'Intermediário';
      2: quVagaSoftware.FieldByName('Nivel').Value := 'Avançado';
    end;
  except
  end;
end;
...
begin
  ...
  begin
    case quEncaminhamentoEva_resultado.AsInteger of
      ...
      5: quEncaminhamentoResultado.Value := 'Não entrevistado pelo Cliente';
  ...
  begin
    case quEncaminhamentopcu_peratual.AsInteger of
      ...
      1: quEncaminhamentoDescPeriodo.Value := 'Período';
    end;
  end;
  ...
  begin
    case quEncaminhamentopcu_turno.AsInteger of
      0: quEncaminhamentoComplemento.Value := 'Manhã';
...
begin
  ...
  begin
    case quTceTce_situacao.AsInteger of
      ...
      1: quTceDescSituacao.Value := '1ª Prorrogação';
      2: quTceDescSituacao.Value := '2ª Prorrogação';
      3: quTceDescSituacao.Value := '3ª Prorrogação';
      4: quTceDescSituacao.Value := '4ª Prorrogação';
      5: quTceDescSituacao.Value := '5ª Prorrogação';
      6: quTceDescSituacao.Value := '6ª Prorrogação';
...
begin
  ...
  begin
    case quTceAlteracaoTal_tipobolsa.AsInteger of
      ...
      1: quTceAlteracaoDescBolsa.Value := 'Mês';
    end;
  end;
...
begin
  ...
  begin
    ...
    case questempSituacao.AsInteger of
      ...
      1: questempDescSituacao.Value := '1ª Prorrogação';
      2: questempDescSituacao.Value := '2ª Prorrogação';
      3: questempDescSituacao.Value := '3ª Prorrogação';
      4: questempDescSituacao.Value := '4ª Prorrogação';
      5: questempDescSituacao.Value := '5ª Prorrogação';
      6: questempDescSituacao.Value := '6ª Prorrogação';
    end;
  end;
  ...
  begin
    ...
    begin
      if quEstEmpest_pgtolib.AsInteger = 0 then
        quEstEmpDescLiberacao.Value := 'Relatórios Pendentes'
      else
        quEstEmpDescLiberacao.Value := quEstEmpDescLiberacao.Value + ' Relatórios Pendentes';
    end;
  end;
...
begin
  if (not quVerEscpcu_peratual.IsNull) and (quVerEscpcu_peratual.Value <> '') then
    case quVerEscpcu_peratual.AsInteger of
      0: quVerEscSemestre.Value := quVerEscpcu_anoAtual.Text + 'º Ano';
      1: quVerEscSemestre.Value := quVerEscpcu_anoAtual.Text + 'º Periodo';
    end;
end;
...
begin
  ...
  begin
    ...
    begin
      if quFolhaPgtofbo_situacao.AsInteger = 0 then
        quFolhaPgtoDescSituacao.Value := 'Relatórios Pendentes'
      else
        quFolhaPgtoDescSituacao.Value := quFolhaPgtoDescSituacao.Value + ' Relatórios Pendentes';
    end;
  end;
  ...
  begin
    ...
    if quFolhapgtocod_retorno.AsString = 'AG' then
      quFolhapgtoRetorno.AsString := 'NUMERO DE LOTE INVÁLIDO';
    if quFolhapgtocod_retorno.AsString = 'AH' then
      quFolhapgtoRetorno.AsString := 'NÚMERO SEQUENCIAL DE RESTRO NO LOTE INVÁLIDO';
    if quFolhapgtocod_retorno.AsString = 'AI' then
      quFolhapgtoRetorno.AsString := 'PRODUTO DEMOSTRATIVO DE PAGAMENTO NÃO CONTRATADO';
    if quFolhapgtocod_retorno.AsString = 'AJ' then
      quFolhapgtoRetorno.AsString := 'TIPO DE MOVIMENTO INVÁLIDO';
    if quFolhapgtocod_retorno.AsString = 'AL' then
      quFolhapgtoRetorno.AsString := 'CÓDIGO DO BANCO FAVORECIDO INVÁLIDO';
    if quFolhapgtocod_retorno.AsString = 'AM' then
      quFolhapgtoRetorno.AsString := 'AGÊNCIA DO FAVORECIDO INVÁLIDA';
    if quFolhapgtocod_retorno.AsString = 'AN' then
      quFolhapgtoRetorno.AsString := 'CONTA CORRENTE DO FAVORECIDO INVÁLIDA';
    if quFolhapgtocod_retorno.AsString = 'AO' then
      quFolhapgtoRetorno.AsString := 'NOME DO FAVORECIDO INVÁLIDO';
    if quFolhapgtocod_retorno.AsString = 'AP' then
      quFolhapgtoRetorno.AsString := 'DATA DE PAGAMENO/DATA DE VALIDADE/ HORA DO LANCAMENTO ARRECADAÇÃO / APURAÇÃO INVÁLIDA';
 ...
 AG  NUMERO DE LOTE INVÁLIDO
 AH  NÚMERO SEQUENCIAL DE RESTRO NO LOTE INVÁLIDO
 AI  PRODUTO DEMOSTRATIVO DE PAGAMENTO NÃO CONTRATADO
 ...
 AP  DATA DE PAGAMENO/DATA DE VALIDADE/ HORA DO LANCAMENTO ARRECADAÇÃO / APURAÇÃO INVÁLIDA
...
begin
  ...
  begin
    if qusFolhaPgtofbo_situacao.AsInteger = 0 then
      qusFolhaPgtoDescSituacao.Value := 'Relatórios Pendentes'
    else
      qusFolhaPgtoDescSituacao.Value := qusFolhaPgtoDescSituacao.Value + ' Relatórios Pendentes';
  end;
  ...
  if (not quSFolhaPgtofbo_liberacao.IsNull) and
    ...
    case quSFolhaPgtofbo_liberacao.AsInteger of
      0: quSFolhaPgtoDescLiberacao.Value := 'Não';
...
begin
  if DmDta.quEstudanteest_situacao.Value = 'S' then
    ...
    DMDta.quEstudanteDescSituacao.Value := 'Não Estagiando'
  else if DmDta.quEstudanteest_situacao.Value = 'X' then
    DMDta.quEstudanteDescSituacao.Value := 'Ex-Estagiário';
...
begin
  ...
  if quTriagemest_situacao.Value = 'X' then
    quTriagemsituacao.Value := 'Ex-estagiário'
  else
...
begin
  ...
  case quRCaixacai_mes.Value of
    ...
    3: quRCaixaMesExtenso.Value := 'MARÇO';
...
begin
  if (not quEstRescpcu_peratual.IsNull) and (quEstRescpcu_peratual.Value <> '') then
    case quEstRescpcu_peratual.AsInteger of
      0: quEstRescSemestre.Value := quEstRescpcu_anoAtual.Text + 'º Ano';
      1: quEstRescSemestre.Value := quEstRescpcu_anoAtual.Text + 'º Periodo';
    end;
...
var
  ...
  begin
    case quTaxatce_Situacao.AsInteger of
      ...
      1: quTaxaDescSituacao.Value := '1ª Prorrogação';
      2: quTaxaDescSituacao.Value := '2ª Prorrogação';
      3: quTaxaDescSituacao.Value := '3ª Prorrogação';
      4: quTaxaDescSituacao.Value := '4ª Prorrogação';
      5: quTaxaDescSituacao.Value := '5ª Prorrogação';
      6: quTaxaDescSituacao.Value := '6ª Prorrogação';
...
begin
  ...
  {
  // Faz o cálculo do valor da bolsa proporcional se for estagiário rescindido
  ...
  // Cálculo da taxa em cima do valor da bolsa
...
begin
  if Fatura = 0 then // Fatura = 0 controle pelo GRID, não pode inserir
    abort;
end;
...
begin
  ...
  begin
    if quFormandospcu_peratual.Value = '0' then
      quFormandosAnoPeriodo.Value := quFormandospcu_anoatual.Text + 'º Ano'
    else
      quFormandosAnoPeriodo.Value := quFormandospcu_anoatual.Text + 'º Período';
  end;

  quFormandosVestibular.Value := 'Não informado';

  if (not quFormandospcu_vestib.IsNull) then
  begin
    if quFormandospcu_vestib.Value = '0' then
      quFormandosVestibular.Value := 'Verão'
  ...
  begin
    ...
    begin
      case quContUFPRTce_situacao.AsInteger of
        ...
        1: quContUFPRDescSituacao.Value := '1ª Prorrogação';
        2: quContUFPRDescSituacao.Value := '2ª Prorrogação';
        3: quContUFPRDescSituacao.Value := '3ª Prorrogação';
        4: quContUFPRDescSituacao.Value := '4ª Prorrogação';
        5: quContUFPRDescSituacao.Value := '5ª Prorrogação';
        6: quContUFPRDescSituacao.Value := '6ª Prorrogação';
...
begin
  ...
  case quEntrevista.FieldByName('Eva_resultado').AsInteger of
   ...
   // 4: quEntrevista.FieldByName('Resultado').Value := 'Não Encaminhado';
    5: quEntrevista.FieldByName('Resultado').Value := 'Não entrevistado pelo Cliente';
...
begin
  ...
  begin
    ...
    case car of
      '0': DmDta.quconsEstudanteturno.AsString := 'Manhã';
      '1': DmDta.quconsEstudanteturno.AsString := 'Tarde';
      '2': DmDta.quconsEstudanteturno.AsString := 'Noite';
      '3': DmDta.quconsEstudanteturno.AsString := 'Manhã & Tarde';
      '4': DmDta.quconsEstudanteturno.AsString := 'Manhã & Noite';
  ...
  if (not quconsEstudantepcu_peratual.IsNull) and (quconsEstudantepcu_peratual.Value <> '') then
    case quconsEstudantepcu_peratual.AsInteger of
      0: quconsEstudanteSemestre.Value := quconsEstudantepcu_anoAtual.Text + 'º Ano';
      1: quconsEstudanteSemestre.Value := quconsEstudantepcu_anoAtual.Text + 'º Periodo';
    end;
  if DmDta.quconsEstudanteest_situacao.Value = 'S' then
    ...
    DMDta.quconsEstudanteSituacao.Value := 'Não Estagiando'
  else if DmDta.quconsEstudanteest_situacao.Value = 'X' then
    DMDta.quconsEstudanteSituacao.Value := 'Ex-Estagiário';
end;
...
begin
  ...
  case qucontatosstatus.AsInteger of
    1: qucontatossituacao.AsString := 'Ninguém atende';
    2: qucontatossituacao.AsString := 'Telefone ocupado';
    3: qucontatossituacao.AsString := 'Indisponível';
    4: qucontatossituacao.AsString := 'Recado';
    5: qucontatossituacao.AsString := 'Número incorreto';
    6: qucontatossituacao.AsString := 'Trabalhando/Efetivo';
    7: qucontatossituacao.AsString := 'Estagiando';
    8: qucontatossituacao.AsString := 'Bolsa-auxílio insuficiente';
    9: qucontatossituacao.AsString := 'Trancou matrícula';
...
var
  ...
  var
    sOrdem: String;
  begin
    sOrdem := IntToStr(qryRel.FieldByName('ORDEM').asInteger)+'º';
