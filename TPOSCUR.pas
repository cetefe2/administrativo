...
begin
  ...
  begin
    ...
    sql.add('  e.est_cpf, e.est_cidade, e.cur_nome, 0 Situacao, ');
...
var
  ...
  Function IncluiMedio(): String;
  begin
    If Medio then
      Result := '  and (e.cur_cod = 131 or e.cur_nome like ''%TÉCNICO%'' or e.cur_nome like ''%TECNOLOGIA%'')'; // ensino médio
  end;
...
begin
  ...
  begin
    ...
    Sql.Add('  e.est_cod, e.est_nome, e.est_endereco, e.est_dtnasc, e.inst_nome, e.est_bairro,');
    Sql.Add('  e.est_fone1, m.emp_cod, m.emp_nome, m.emp_telefone, m.emp_nomerespcomp,');
    sql.add('  e.est_cpf, e.est_cidade,e.cur_nome, a.prg_cod Situacao, ');
    ...
    Sql.Add('  e.est_cod, e.est_nome, e.est_endereco, e.est_dtnasc, e.inst_nome, e.est_bairro,');
    Sql.Add('  e.est_fone1, m.emp_cod, m.emp_nome, m.emp_telefone, m.emp_nomerespcomp,');
    sql.add('  e.est_cpf, e.est_cidade,e.cur_nome, 7 Situacao, ');
    Sql.Add('  t.tce_cod, t.tce_dataini, t.tce_datafim, t.tce_situacao, t.tce_datares,');
    Sql.Add('  Convert(DateTime,Null) as tpr_dataini, Convert(DateTime,Null) as tpr_datafim, e.est_pgtolib, i.inst_nivel');
    Sql.Add('from');
    Sql.Add('  tce t, estudante e, Empresa m, Instituicao i');
...
procedure TFORSEMP.btEmailClick(Sender: TObject);
var
  F: TextFile;
  fone, linha: String;
