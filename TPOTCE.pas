...
begin
  ...
  begin
    ...
    begin
      MSGERRO('Vaga do Tipo Seleção. Selecione outra vaga!');
      DBEdit3.SetFocus;
      Exit;
    end
  end;
    ...
    begin
      ...
      begin
        ...
        Horarios := Horarios + ', das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSegini1').Value) +
          ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSegfim1').Value);
        dec(semana);
        ...
        if quPrincipal.FieldByName('tce_HorSegini2').asstring <> '' then
          horarios := horarios + ' e das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSegini2').Value) +
            ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSegfim2').Value);
    ...
    begin
      ...
      begin
        ...
        Horarios := horarios + ', das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorTerini1').Value) +
          ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorTerfim1').Value);
        ...
        if quPrincipal.FieldByName('tce_HorTerini2').asstring <> '' then
          horarios := horarios + ' e das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorTerini2').Value) +
            ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorTerfim2').Value);
    ...
    begin
      ...
      begin
        ...
        Horarios := Horarios + ', das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorQuaini1').Value) +
          ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorQuafim1').Value);
        dec(semana);
        ...
        if quPrincipal.FieldByName('tce_HorQuaini2').asstring <> '' then
          horarios := horarios + ' e das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorQuaini2').Value) +
            ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorQuafim2').Value);
    ...
    begin
      ...
      begin
        ...
        Horarios := Horarios + ', das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorQuiini1').Value) +
          ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorQuifim1').Value);
        dec(semana);
        ...
        if quPrincipal.FieldByName('tce_HorQuiini2').asstring <> '' then
          horarios := horarios + ' e das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorQuiini2').Value) +
            ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorQuifim2').Value);
    ...
    begin
      ...
      begin
        ...
        Horarios := Horarios + ', das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSexini1').Value) +
          ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSexfim1').Value);
        dec(semana);
        ...
        if quPrincipal.FieldByName('tce_HorSexini2').asstring <> '' then
          horarios := horarios + ' e das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSexini2').Value) +
            ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSexfim2').Value);
    ...
    begin
      ...
      begin
        ...
        Horarios := Horarios + ', das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSabini1').Value) +
          ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSabfim1').Value);
        dec(semana);
        ...
        if quPrincipal.FieldByName('tce_HorSabini2').asstring <> '' then
          horarios := horarios + ' e das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSabini2').Value) +
            ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorSabfim2').Value);
    ...
    begin
      ...
      begin
        ...
        Horarios := horarios + ', das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorDomini1').Value) +
          ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorDomfim1').Value);
        dec(semana);
        ...
        if quPrincipal.FieldByName('tce_HorDomini2').asstring <> '' then
          horarios := horarios + ' e das ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorDomini2').Value) +
            ' às ' + FormatDateTime('hh:nn', quPrincipal.FieldByName('tce_HorDomfim2').Value);
...
var
...

  {
    ...
    Var1.Insert(meTceDtIni.Text + ' à ' + meTceDtfim.Text);
    ...
    if dmdta.quTcevagaAuxTransp.AsString = 'P' then
      if dmdta.quTcevagaAuxTranspValor.asstring <> '' then
        Var1.Insert('Auxílio pecuniário no valor mensal de R$ ' + formatfloat('###,##0.00', dmdta.quTcevagaAuxTranspValor.value) + '(' + ansilower(pchar(Extenso(dmdta.quTcevagaAuxTranspValor.value))) + '). ')
      else
...
begin
  ...
  begin
   ...
   { InputQuery('Supervisor', 'Supervisor de Estágio', SuperEst);
    ...
    InputQuery('Orientador', 'Formacao do Orientador de Estágio', carOrientador);
...
begin
  ...
  begin
    showmessage('O registro tem que estar em modo de Edição para executar essa operação!');
    exit;
  end;
  if DmDta.quTceVAG_COD.AsString = '' then
    EXIT;
  if MSGSIMNAO('Reimportar informaçoes da vaga?') then
  begin
    with TQuery.Create(nil) do
    begin
      DatabaseName := DATABASE_NAME;
...
{  procedure Imprime;
  ...
  if ckf1.Checked then
    Var1.Insert('Formação Acadêmica: ' + #9 + DmDTA.quTceFormacao.AsString);
  if ckr1.Checked then
  begin
    if ckf1.Checked then
      Var1.Insert(#9 + 'Nº Registro Conselho:' + #9 + DmDTA.quTceregistro.AsString + #13)
    else
      Var1.Insert('Nº Registro Conselho:' + #9 + DmDTA.quTceregistro.AsString + #13)
  end
  else
    if ckf1.Checked then
      Var1.Insert(#13);
  ...
  if ckf2.Checked then
    Var1.Insert('Outra Formação: ' + #9 + DmDTA.quTceoutraformacao.AsString);
  if ckr2.Checked then
  begin
    if ckf2.Checked then
      Var1.Insert(#9 + 'Nº Registro Conselho:' + #9 + DmDTA.quTceregistro2.AsString + #13)
    else
      Var1.Insert('Nº Registro Conselho:' + #9 + DmDTA.quTceregistro2.AsString + #13)
  end
  else
    if ckf2.Checked then
      Var1.Insert(#13);
  ...
  verfonte;
  if ckarea.Checked then
    Var1.Insert('Área de atuação: ' + #9 + DmDTA.quTcearea.AsString + #13);
  verfonte;

  if cktempo.Checked then
    Var1.Insert('Tempo de experiência comprovada: ' + DmDTA.quTceTempo.AsString + #13);
  Var1.Insert(#13);
  verfonte;
  ...
  verfonte;
  if CodEsc = '331' then
    Var1.Insert('Matrícula: ' + #9 + dmdta.qutcetce_matricula.asstring + #13);
  verfonte;
...
//    Var1.Font('Arial', 9);
  ...
  Var1.Insert(#13);
    ...
    // Cláusula 02
  Var1.Bold;
  Var1.Insert('CLÁUSULA SEGUNDA: LOCAL E JORNADA DE ESTÁGIO' + #13);
  ...
  Var1.Insert(#13);
   ...
   //   var1.InsertPageBreak;
    ...
    // Cláusula 03
  Var1.Bold;
  Var1.Insert('CLÁUSULA TERCEIRA: ATIVIDADES' + #13);
  ...
  Var1.Insert(#13);
    ...
    // Cláusula 04
  Var1.Bold;
  Var1.Insert('CLÁUSULA QUARTA: BOLSA-AUXÍLIO E AUXÍLIO TRANSPORTE ' + #13);
  ...
  if dmdta.quTcevagaAuxTransp.AsString = 'P' then
    if dmdta.quTcevagaAuxTranspValor.asstring <> '' then
      Var1.Insert('Auxílio pecuniário no valor mensal de R$ ' + formatfloat('###,##0.00', dmdta.quTcevagaAuxTranspValor.value) + '(' + ansilower(pchar(Extenso(dmdta.quTcevagaAuxTranspValor.value))) + '). ' + #13 + #13)
    else
...
//    Var1.Font('Arial', 9);
  ...
  Var1.Insert('Este Termo de Compromisso de Estágio terá vigência de ' + meTceDtIni.Text + ' até ' + meTceDtFim.text + ', podendo ser prorrogado através de Termo Aditivo, desde que o prazo total não seja superior a 2 (dois) anos.' + #13);
  Var1.Bold;
  Var1.Insert('Parágrafo Único: ');
  Var1.Bold;
