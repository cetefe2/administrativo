...
procedure TFORSEL.InicializaDados;
begin
  inherited;
...
procedure TFORSEL.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TFORSEL.edParametroKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if cbTipoPesquisa.ItemIndex = 0 then VerificaNumero(key);
end;

procedure TFORSEL.edParametroExit(Sender: TObject);
...
procedure TFORSEL.btSalvarClick(Sender: TObject);
var
  Insere: boolean;
begin
...
procedure TFORSEL.btExcluirClick(Sender: TObject);
begin
